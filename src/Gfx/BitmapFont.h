...
V2I calculateTextSize(BitmapFont* font, StringView text, s32 maxWidth = 0);
V2I calculateTextPosition(V2I origin, V2I size, Alignment align);
s32 calculateMaxTextWidth(BitmapFont* font, std::initializer_list<StringView> texts, s32 limit = 0);
