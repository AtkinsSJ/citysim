...
struct Asset {
    ...
    explicit Asset(AssetType type, String short_name, String full_path, Flags<AssetFlags> flags)
        : type(type)
...
public:
    ...
    Cursor(String short_name, String full_path, Flags<AssetFlags> flags, String image_file_path, V2I hotspot);
