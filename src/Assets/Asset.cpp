...
Asset* Asset::make_placeholder(AssetType type)
{
    ...
    case AssetType::Cursor:
        ...
        break;
    default:
        asset = asset_manager().arena.allocate<Asset>(type, String {}, String {}, AssetFlags {});
        break;
    }
...
{
    return asset_manager().arena.allocate<Cursor>(String {}, String {}, AssetFlags {}, String {}, V2I {});
}

Cursor::Cursor(String short_name, String full_path, Flags<AssetFlags> flags, String image_file_path, V2I hotspot)
    : Asset(AssetType::Cursor, short_name, full_path, flags)
