...
void startFrame()
{
    ...
    windowSize = v2i(renderer->ui_camera().size);
    mousePos = v2i(renderer->ui_camera().mousePos);
    if (mouseButtonPressed(MouseButton_Left)) {
        mouseClickStartPos = v2i(getClickStartPos(MouseButton_Left, &renderer->ui_camera()));
    }
}
