...
void drawText(RenderBuffer *renderBuffer, BitmapFont *font, String text, Rect2 bounds, f32 depth, V4 color, s32 shaderID, s32 caretPosition=-1, DrawTextResult *caretInfoResult=null);
