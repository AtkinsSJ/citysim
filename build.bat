...
where /q cl.exe || call "C:\Program Files (x86)\Microsoft Visual Studio\2017\Community\VC\Auxiliary\Build\vcvarsall.bat" x64

REM to send preprocessor output to a file, add this to the compiler flags:  -P -Fipreprocessed.output 

set COMPILER_FLAGS= -EHsc -MD -W4 -wd4201 -Zi -Od -Oi -std:c++17 -DBUILD_DEBUG=1 -I ..\include -FC 
